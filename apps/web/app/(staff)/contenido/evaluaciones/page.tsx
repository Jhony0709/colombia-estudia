...
export default async function AssessmentsPage() {
  ...
  return (
    <Page>
      <PageHeader
        ...
        action={
          <Button asChild variant="secondary">
            <Link href="/contenido/evaluaciones/nuevo">{t('newAssessment')}</Link>
          </Button>
        }
      />
      ...
      <PageSection title={t('assessmentsTitle', { count: assessments.length })} id="evaluaciones">
          ...
          columns={[
            {
              ...
              cell: (assessment) => (
                <Link
                  href={`/contenido/evaluaciones/${assessment.id}`}
            ...
            },
            {
              ...
              cell: (a) =>
                a.latestStatus === null ? (
                  ...
                  <Badge variant={a.latestStatus === 'PUBLISHED' ? 'success' : 'neutral'}>
                    {t(`status.${a.latestStatus}`, { number: a.latestNumber ?? 0 })}
                  </Badge>
                ),
            },
          ]}
