...
const STAFF_DYNAMIC_PAGES = [
  ...
  '/aprender/evaluacion/[assignmentId]',
  '/aprender/evaluacion/[assignmentId]/intento/[attemptId]',
  '/aprender/resultados',
  ...
  '/contenido/evaluaciones/[assessmentId]',
] as const;
